...
export const workspaceFeature = createFeature({
  ...
  reducer: createReducer(
    ...
    on(
      workspaceActions.loadSourcesFailure,
    ...
    on(
      workspaceActions.setActiveSource,
      (state, { sourceId }): WorkspaceState => ({
        ...state,
    ...
    on(
      workspaceActions.submitImportSuccess,
      (state, { submission }): WorkspaceState => ({
        ...state,
    ...
    on(
      workspaceActions.submitImportFailure,
      (state, { error }): WorkspaceState => ({
        ...state,
        import: {
          ...state.import,
    ...
    on(
      workspaceActions.pollImportJob,
      (state): WorkspaceState => ({
        ...state,
        import: {
          ...state.import,
    ...
    on(
      workspaceActions.pollImportJobSuccess,
      (state, { job }): WorkspaceState => ({
        ...state,
        import: {
          ...state.import,
          activeJob: job,
    ...
    on(
      workspaceActions.pollImportJobFailure,
      (state, { error }): WorkspaceState => ({
        ...state,
        import: {
          ...state.import,
    ...
    on(
      workspaceActions.submitAskSuccess,
    ...
    on(
      workspaceActions.submitAskFailure,
      (state, { error }): WorkspaceState => ({
        ...state,
        ask: {
          submitting: false,
