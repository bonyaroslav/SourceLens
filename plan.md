...
- target **1024-dimensional embeddings**
...
3. **Qdrant local integration**
   - create collection
   - insert test vectors
   - run similarity search

4. **file ingestion vertical slice**
...
5. add Qdrant local dependency
6. create one import script for a text file
7. create one ask script / endpoint
8. test the full flow on one document
